  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 w-16 h-16 bg-gradient-to-br from-sky-500 to-purple-600 text-white rounded-full shadow-2xl hover:scale-110 transition-transform z-50 flex items-center justify-center"
      >
        {isOpen ? (
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-96 h-[600px] bg-white rounded-2xl shadow-2xl z-50 flex flex-col overflow-hidden border border-gray-200">
          <div className="bg-gradient-to-r from-sky-500 to-purple-600 text-white p-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-sky-100">Typically replies instantly</p>
              </div>
              <button
          ...
          <div className="border-t border-gray-200 p-3 bg-white">
            ...
            <div className="flex items-center gap-2">
              ...
              <input
                ...
                className="flex-1 px-4 py-2 bg-gray-100 rounded-full focus:outline-none focus:ring-2 focus:ring-sky-500"
              />
              <button
                onClick={handleSendMessage}
                className="w-9 h-9 flex items-center justify-center bg-sky-500 hover:bg-sky-600 text-white rounded-full transition-colors"
              >
