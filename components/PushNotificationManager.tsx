    ...
    <div className="fixed bottom-4 right-4 w-96 bg-white rounded-xl shadow-2xl p-6 z-50 border border-gray-200 animate-slide-up">
      <div className="flex items-start gap-4">
        <div className="w-12 h-12 bg-sky-100 rounded-xl flex items-center justify-center flex-shrink-0">
          <i className="ri-notification-line text-2xl text-sky-700"></i>
        </div>
        <div className="flex-1">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 bg-sky-700 hover:bg-sky-800 text-white py-2 px-4 rounded-lg font-medium transition-colors whitespace-nowrap"
            >
