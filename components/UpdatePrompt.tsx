...
export default function UpdatePrompt() {
  ...
  return (
    <div className="fixed bottom-20 left-4 right-4 md:left-auto md:right-4 md:max-w-sm z-[9998] pwa-update-toast">
      <div className="bg-sky-600 text-white rounded-2xl p-4 shadow-2xl flex items-center gap-4">
        ...
        <button
          ...
          className="bg-sky-600 hover:bg-sky-500 text-white px-4 py-2 rounded-xl text-sm font-semibold transition-colors flex-shrink-0 active:scale-95"
        >
          Update
        </button>
        <button
