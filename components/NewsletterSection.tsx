      ...
      <div className="bg-[#0c1929] rounded-[2rem] overflow-hidden shadow-2xl relative">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between p-8 md:p-10 lg:p-12 gap-8">
          ...
          <div className="text-center lg:text-left max-w-xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-sky-900/50 border border-sky-500/30 text-sky-300 text-xs font-bold tracking-widest uppercase mb-4 animate-pulse-glow">
          ...
          <div className="w-full max-w-md bg-white/5 backdrop-blur-md p-1.5 rounded-2xl border border-white/10 pwa-submit-form">
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2">
              ...
              <button
                ...
                className="bg-sky-400 hover:bg-sky-400 text-blue-950 font-bold px-6 py-3 rounded-xl transition-all hover:scale-105 active:scale-95 disabled:opacity-75 disabled:cursor-not-allowed shadow-lg whitespace-nowrap text-sm"
              >
                {isSubmitting ? (
