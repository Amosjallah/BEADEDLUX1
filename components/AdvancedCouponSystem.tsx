      ...
      {!appliedCoupon ? (
        <>
          <div>
            ...
            <div className="flex space-x-2">
              <input
                ...
                className="flex-1 px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm"
              />
              <button
                onClick={handleApply}
                className="bg-sky-600 hover:bg-sky-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
              >
                Apply
              </button>
            </div>
          ...
          <button
            ...
            className="text-sm text-sky-700 hover:text-sky-900 font-medium flex items-center whitespace-nowrap"
          >
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      {isEligible && (
                        <button
                          ...
                          className="text-sky-700 hover:text-sky-900 font-semibold text-sm whitespace-nowrap"
                        >
                          Apply
                        </button>
                      )}
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center space-x-2 mb-1">
                <i className="ri-price-tag-3-fill text-sky-700"></i>
                <span className="font-bold text-sky-800">{appliedCoupon.code}</span>
              </div>
              <p className="text-sm text-sky-700">{appliedCoupon.description}</p>
            </div>
            <button
              onClick={onRemove}
              className="w-8 h-8 flex items-center justify-center text-sky-700 hover:text-sky-900 transition-colors"
            >
