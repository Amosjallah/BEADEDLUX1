  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        <div 
          className="fixed inset-0 transition-opacity bg-sky-600 bg-opacity-75"
          onClick={onClose}
        ></div>
                    ...
                    {images.map((image, index) => (
                      <button
                        ...
                        className={`relative aspect-square bg-gray-100 rounded-lg overflow-hidden border-2 transition-colors ${
                          selectedImage === index ? 'border-sky-700' : 'border-transparent hover:border-gray-300'
                        }`}
                      >
              ...
              <div className="flex flex-col">
                <div className="mb-2">
                  <Link 
                    ...
                    className="text-sm text-sky-700 hover:text-sky-800 font-medium whitespace-nowrap"
                  >
                    {product.category}
                  </Link>
                </div>
