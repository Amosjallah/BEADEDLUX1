...
const ADMIN_EMAIL = process.env.ADMIN_EMAIL || 'beadedlux@gmail.com';
const EMAIL_FROM = process.env.EMAIL_FROM || 'BEADEDLUX <beadedlux@gmail.com>';
const BRAND = {
    name: 'BEADEDLUX',
    color: '#8cbce1',
    colorLight: '#f4f9ff',
...
<p style="margin:6px 0 0;color:rgba(255,255,255,0.8);font-size:12px;letter-spacing:1.5px;text-transform:uppercase;">Handcrafted Ladies Bags · Luxury Collection</p>
</td></tr>
...
<p style="color:#374151;font-size:14px;line-height:1.7;margin:16px 0;">Thank you for joining the ${BRAND.name} family. We offer premium handcrafted bags designed for elegance and style &mdash; perfect for every occasion.</p>
