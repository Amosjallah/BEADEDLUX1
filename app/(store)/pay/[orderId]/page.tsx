    ...
    return (
      <main className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 border-4 border-sky-200 border-t-blue-700 rounded-full animate-spin mx-auto mb-4"></div>
    ...
    return (
      <main className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          ...
          <Link
            href="/"
            className="inline-flex items-center px-6 py-3 bg-sky-700 hover:bg-sky-800 text-white rounded-lg font-semibold transition-colors"
          >
      ...
      <div className="max-w-lg mx-auto">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-block mb-6">
            <span className="text-2xl font-['Pacifico'] text-sky-700">TIWAA PERFUME STYLE HOUSE</span>
          </Link>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          ...
          <div className="flex justify-between items-center pt-4 border-t border-gray-200">
            ...
            <span className="text-2xl font-bold text-sky-700">$ {order?.total?.toFixed(2)}</span>
          </div>
        </div>
        ...
        <button
          ...
          disabled={processing}
          className="w-full bg-sky-700 hover:bg-sky-800 text-white py-4 rounded-xl font-semibold text-lg transition-colors disabled:opacity-70 flex items-center justify-center cursor-pointer"
        >
          {processing ? (
            <>
        ...
        <div className="mt-8 text-center">
          <p className="text-sm text-gray-600">
            Having issues? <Link href="/contact" className="text-sky-700 hover:underline">Contact Support</Link>
          </p>
        </div>
      </div>
    </main>
