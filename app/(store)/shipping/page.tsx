...
export default function ShippingPage() {
  const deliveryOptions = [
    ...
    },
    {
      ...
      time: 'Same Day',
      cost: 'FREE',
      description: 'Collect from our Texas location',
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Fast, reliable delivery across the USA. Free standard shipping on orders over $300.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {deliveryOptions.map((option, index) => (
              <div key={index} className="bg-white border-2 border-gray-200 p-8 rounded-2xl hover:border-sky-500 hover:shadow-lg transition-all">
                <div className="w-14 h-14 bg-sky-100 rounded-full flex items-center justify-center mb-6">
                  <i className={`${option.icon} text-2xl text-sky-700`}></i>
                </div>
                <h3 className="text-2xl font-bold text-gray-900 mb-2">{option.type}</h3>
                <div className="text-sky-700 font-bold text-xl mb-2">{option.cost}</div>
        ...
        <div className="bg-sky-50 border-2 border-sky-200 rounded-2xl p-8 mb-16 text-center">
          ...
          <p className="text-lg text-gray-600">
            Spend $300 or more and get <span className="font-bold text-sky-700">FREE standard delivery</span> anywhere in the USA
          </p>
        </div>
            ...
            <div className="bg-gray-50 rounded-2xl p-6 space-y-6">
              <div>
                <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                  <i className="ri-time-line text-sky-700"></i>
                  Cut-off Times
                </h3>
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                  <i className="ri-calendar-line text-sky-700"></i>
                  Business Days
                </h3>
                <p className="text-gray-600 leading-relaxed text-sm">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                  <i className="ri-phone-line text-sky-700"></i>
                  Delivery Contact
                </h3>
                <p className="text-gray-600 leading-relaxed text-sm">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                  <i className="ri-home-line text-sky-700"></i>
                  Failed Deliveries
                </h3>
                <p className="text-gray-600 leading-relaxed text-sm">
              ...
              <div>
                <h3 className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                  <i className="ri-secure-payment-line text-sky-700"></i>
                  Package Security
                </h3>
                <p className="text-gray-600 leading-relaxed text-sm">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-8 mb-16">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="w-12 h-12 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-checkbox-circle-line text-2xl text-sky-700"></i>
              </div>
            ...
            <div className="text-center">
              <div className="w-12 h-12 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <i className="ri-gift-line text-2xl text-sky-700"></i>
              </div>
          ...
          <div className="mt-8 text-center">
            <Link
              href="/order-tracking"
              className="inline-flex items-center gap-2 bg-sky-700 text-white px-8 py-4 rounded-full font-medium hover:bg-sky-800 transition-colors whitespace-nowrap"
            >
        ...
        <div className="bg-gradient-to-br from-sky-700 to-sky-900 rounded-2xl p-8 text-white text-center">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 bg-white text-sky-700 px-6 py-3 rounded-full font-medium hover:bg-sky-50 transition-colors whitespace-nowrap"
            >
              Contact Support
            </Link>
            <Link
              href="/faqs"
              className="inline-flex items-center gap-2 bg-sky-600 text-white px-6 py-3 rounded-full font-medium hover:bg-sky-500 transition-colors whitespace-nowrap"
            >
              View FAQs
            </Link>
          </div>
