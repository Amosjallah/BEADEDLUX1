  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-sky-700 hover:text-sky-800 mb-6 whitespace-nowrap"
        >
            ...
            <div className="space-y-4">
              ...
              {notificationPermission === 'granted' && (
                <div className="bg-sky-50 border border-sky-200 rounded-xl p-4">
                  <p className="text-sm text-sky-800 font-medium mb-2">You will receive notifications for:</p>
          ...
          <div className="bg-white rounded-2xl shadow-sm p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-sky-50 rounded-xl">
                <div className="flex items-center gap-3 mb-2">
                  <i className="ri-rocket-line text-sky-700 text-xl"></i>
                  <span className="font-semibold text-sky-900">Fast Loading</span>
                </div>
                <p className="text-sm text-sky-800">Instant page loads with smart caching</p>
              </div>
