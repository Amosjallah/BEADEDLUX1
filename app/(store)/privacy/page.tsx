        ...
        <div className="prose prose-lg max-w-none">
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
                  <i className="ri-shopping-bag-line text-sky-700"></i>
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
                  <i className="ri-line-chart-line text-sky-700"></i>
                  Service Improvement
                </h3>
                <p className="text-gray-600 text-sm leading-relaxed">
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
                  <i className="ri-mail-line text-sky-700"></i>
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
                  <i className="ri-shield-check-line text-sky-700"></i>
              ...
              <div className="bg-gray-50 p-6 rounded-xl">
                <h3 className="font-bold text-gray-900 mb-3 flex items-center gap-2">
                  <i className="ri-scales-line text-sky-700"></i>
                  Legal Compliance
                </h3>
                <p className="text-gray-600 text-sm leading-relaxed">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-sky-50 border border-sky-200 p-6 rounded-xl">
                <div className="w-10 h-10 bg-sky-700 rounded-full flex items-center justify-center mb-4">
          ...
          <section className="mb-12">
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-sky-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <i className="ri-eye-line text-sky-700"></i>
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-sky-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <i className="ri-pencil-line text-sky-700"></i>
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-sky-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <i className="ri-delete-bin-line text-sky-700"></i>
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-sky-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <i className="ri-mail-close-line text-sky-700"></i>
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-sky-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <i className="ri-download-line text-sky-700"></i>
                </div>
                <div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-8 h-8 bg-sky-100 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <i className="ri-hand-coin-line text-sky-700"></i>
                </div>
                <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              To exercise any of these rights, please contact us at <a href="mailto:beadedlux@gmail.com" className="text-sky-700 font-medium hover:underline">beadedlux@gmail.com</a> or through your account settings. We will respond within 30 days.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-gray-600 leading-relaxed">
              Your information may be transferred to and processed in countries outside USA, including countries that may have different data protection laws. We ensure appropriate safeguards are in place to protect your information in accordance with this privacy policy.
            </p>
          </section>
