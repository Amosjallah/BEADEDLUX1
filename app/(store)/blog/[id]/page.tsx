...
export default async function BlogPostPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const posts: any = {
    '1': {
      title: 'The Ultimate Guide to Online Shopping in USA',
      ...
      author: 'Ama Osei',
      content: `
        <p>Online shopping has revolutionised the way USAians purchase products, offering convenience, variety, and competitive prices. However, navigating the world of ecommerce can be daunting if you're new to it. This comprehensive guide will help you shop online safely and confidently.</p>

        <h2>Why Shop Online in USA?</h2>
        ...
        <h2>Payment Methods in USA</h2>
        <p>USAian online shoppers have several secure payment options:</p>
        <ul>
        ...
        <p>Delivery times and costs vary by location. In Texas and major cities, you can often get next-day delivery. Remote areas may take longer. Always check:</p>
        <ul>
    ...
    '2': {
      ...
      content: `
        ...
        <p>Invest in quality sheets, duvet covers, and pillows. Good sleep is essential, and premium bedding makes a noticeable difference. Look for breathable fabrics suitable for USA's climate.</p>
  ...
  const relatedPosts = [
    {
      id: id === '1' ? '2' : '1',
      title: id === '1' ? '10 Must-Have Products for Your Home This Season' : 'The Ultimate Guide to Online Shopping in USA',
      image: id === '1' ?
    ...
    {
      id: id === '3' ? '1' : '3',
      title: id === '3' ? 'The Ultimate Guide to Online Shopping in USA' : 'How to Choose Quality Products: A Buyer\'s Guide',
      image: id === '3' ?
  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="relative h-96 bg-sky-600">
        <img
          src={post.image}
          alt={post.title}
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <span className="inline-block bg-sky-600 text-white px-4 py-2 rounded-full text-sm font-medium mb-4">
              {post.category}
            </span>
            <h1 className="text-5xl font-bold text-white mb-6">{post.title}</h1>
            <div className="flex items-center justify-center gap-6 text-sky-100">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-sky-100 rounded-full flex items-center justify-center">
                  <i className="ri-user-line text-sky-700 text-xl"></i>
                </div>
                <div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                <button className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-sky-100 transition-colors cursor-pointer">
            ...
            {relatedPosts.map((relatedPost) => (
              ...
              >
                <div className="relative h-48">
                  ...
                  />
                  <span className="absolute top-4 left-4 bg-sky-700 text-white px-3 py-1 rounded-full text-xs font-medium">
        ...
        <div className="mt-16 bg-gradient-to-br from-sky-700 to-sky-900 rounded-2xl p-12 text-center text-white">
          ...
          <form className="max-w-md mx-auto flex gap-3">
            ...
            <button
              type="submit"
              className="bg-white text-sky-700 px-8 py-4 rounded-full font-medium hover:bg-sky-50 transition-colors whitespace-nowrap"
            >
              Subscribe
            </button>
          </form>
