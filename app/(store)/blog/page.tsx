...
export default function BlogPage() {
  const featuredPost = {
    ...
    excerpt: 'Everything you need to know about safe, convenient online shopping in USA. From payment methods to delivery options, we cover it all.',
  ...
  const posts = [
    ...
    },
    {
      id: '1',
      title: 'The Ultimate Guide to Online Shopping in USA',
      excerpt: 'Everything you need to know about safe, convenient online shopping in USA. From payment methods to delivery options.',
              ...
              <div className="p-12 flex flex-col justify-center">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-sky-100 rounded-full flex items-center justify-center">
                    <i className="ri-user-line text-sky-700"></i>
                  </div>
          ...
          <div className="lg:col-span-3">
            ...
            <div className="mt-12 flex justify-center">
              <nav className="flex items-center gap-2">
                ...
                <button className="w-10 h-10 flex items-center justify-center bg-sky-700 text-white rounded-lg cursor-pointer">
                  1
                </button>
                <button className="w-10 h-10 flex items-center justify-center border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer">
                  2
            ...
            <div className="bg-gray-50 rounded-2xl p-6 mb-8 sticky top-24">
              ...
              <div className="space-y-2">
                {categories.map((category, index) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <i className={`${category.icon} text-sky-700`}></i>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <form className="space-y-3">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-sky-700 text-white py-3 rounded-xl font-medium hover:bg-sky-800 transition-colors whitespace-nowrap"
                  >
                    Subscribe
                  </button>
                </form>
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex flex-wrap gap-2">
                  {['Shopping', 'Quality', 'Reviews', 'USA', 'Delivery', 'Tips', 'Home', 'Style'].map((tag, index) => (
                    <button
                      key={index}
                      className="px-4 py-2 bg-white border border-gray-200 rounded-full text-sm text-gray-700 hover:border-sky-500 hover:text-sky-700 transition-colors cursor-pointer whitespace-nowrap"
                    >
                      #{tag}
                    </button>
                  ))}
