...
export default function MyTicketsPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'resolved': return 'bg-sky-100 text-sky-700';
  ...
  const getPriorityColor = (priority: string) => {
    switch (priority) {
      ...
      case 'normal': return 'text-sky-700';
      ...
      <main className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link
              href="/support/ticket"
              className="bg-sky-700 hover:bg-sky-800 text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap"
            >
            ...
            <div className="space-y-4">
              {filteredTickets.map((ticket) => (
                <Link
                  ...
                  className="block bg-white rounded-xl shadow-sm p-6 hover:shadow-lg transition-all border-2 border-transparent hover:border-sky-700"
                >
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            <div className="bg-white rounded-xl shadow-sm p-6">
              <div className="w-12 h-12 flex items-center justify-center bg-sky-100 rounded-lg mb-4">
                <i className="ri-time-line text-2xl text-sky-700"></i>
              </div>
              <h3 className="font-bold text-gray-900 mb-2">Response Time</h3>
              <p className="text-2xl font-bold text-sky-700 mb-1">24 hours</p>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <p className="text-2xl font-bold text-sky-700 mb-1">95%</p>
