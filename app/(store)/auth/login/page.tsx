        ...
        <div className="bg-white rounded-xl shadow-sm p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="/auth/forgot-password" className="text-sm text-sky-700 hover:text-sky-900 font-medium whitespace-nowrap">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-8 text-center text-gray-600">
            ...
            <Link href="/auth/signup" className="text-sky-700 hover:text-sky-900 font-semibold whitespace-nowrap">
              Create one now
            </Link>
          </p>
        </div>
