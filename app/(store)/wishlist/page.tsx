...
export default function WishlistPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <PageHero title="My Wishlist" backgroundImage="/bag-green-croc.jpg" />
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="bg-gradient-to-r from-sky-700 to-sky-800 rounded-2xl p-12 text-center text-white">
            <h2 className="text-3xl font-bold mb-4">Share Your Wishlist</h2>
            <p className="text-sky-100 mb-8 text-lg">Let friends and family know what you love</p>
