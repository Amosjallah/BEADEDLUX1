      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {contactMethods.map((method, index) => (
            <a
              ...
              className="bg-white border border-gray-200 p-6 rounded-2xl hover:shadow-lg hover:border-sky-200 transition-all cursor-pointer"
            >
              <div className="w-12 h-12 bg-sky-100 rounded-full flex items-center justify-center mb-4">
                <i className={`${method.icon} text-2xl text-sky-700`}></i>
              </div>
              <h3 className="font-bold text-gray-900 mb-2">{method.title}</h3>
              <p className="text-sky-700 font-medium mb-1">{method.value}</p>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
            ...
            <form id="contactForm" onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-transparent text-sm"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-transparent resize-none text-sm"
              ...
              {submitStatus === 'success' && (
                <div className="bg-sky-50 border border-sky-200 text-sky-700 px-4 py-3 rounded-xl">
              ...
              <button
                ...
                className="w-full bg-sky-700 text-white py-4 rounded-xl font-medium hover:bg-sky-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap cursor-pointer"
              >
          ...
          <div>
            ...
            <div className="bg-gradient-to-br from-sky-700 to-sky-900 p-8 rounded-2xl text-white">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 text-gray-600">
              <div className="flex items-center gap-2">
                <i className="ri-map-pin-2-line text-sky-700"></i>
