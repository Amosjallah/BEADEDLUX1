    ...
    return (
      <main className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <Link href="/shop" className="text-sky-700 font-semibold hover:underline">
            Return to Shop
          </Link>
        </div>
      </main>
      ...
      <section className="py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6">
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 text-center mb-8">
            <div className="w-24 h-24 flex items-center justify-center mx-auto mb-6 bg-sky-100 rounded-full">
              <i className="ri-checkbox-circle-fill text-6xl text-sky-600"></i>
            </div>
            ...
            <div className="bg-sky-50 rounded-xl p-6 mb-8">
              <div className="grid md:grid-cols-3 gap-6 text-center">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-sky-700">{estimatedDelivery}</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Link
                ...
                className="bg-sky-700 hover:bg-sky-800 text-white px-8 py-4 rounded-lg font-semibold transition-colors inline-flex items-center justify-center whitespace-nowrap"
              >
              ...
              <div className="mt-6 pt-6 border-t border-gray-200">
                ...
                <div className="space-y-3">
                  <div className="flex items-start space-x-3">
                    <i className="ri-mail-line text-sky-700 mt-1"></i>
                    <div>
                  ...
                  <div className="flex items-start space-x-3">
                    <i className="ri-box-3-line text-sky-700 mt-1"></i>
                    <div>
                  ...
                  <div className="flex items-start space-x-3">
                    <i className="ri-truck-line text-sky-700 mt-1"></i>
                    <div>
          ...
          <div className="mt-8 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Link href="/account/orders" className="text-sky-700 hover:text-sky-900 font-semibold whitespace-nowrap">
