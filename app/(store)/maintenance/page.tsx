export default function MaintenancePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-amber-50 flex items-center justify-center px-4">
      <div className="max-w-2xl mx-auto text-center">
        <div className="mb-8">
          <div className="w-32 h-32 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <i className="ri-tools-line text-6xl text-sky-700"></i>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white border border-gray-200 rounded-xl p-6">
            <div className="w-12 h-12 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <i className="ri-rocket-line text-2xl text-sky-700"></i>
            </div>
        ...
        <div className="bg-sky-50 border border-sky-200 rounded-2xl p-8 mb-8">
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 bg-sky-700 text-white px-6 py-3 rounded-full font-medium hover:bg-sky-800 transition-colors whitespace-nowrap"
            >
              <i className="ri-whatsapp-line"></i>
              WhatsApp
            </a>
            <a
              href="tel:+14696865468"
              className="inline-flex items-center gap-2 bg-white text-gray-900 px-6 py-3 rounded-full font-medium hover:bg-gray-50 transition-colors border border-gray-200 whitespace-nowrap"
            >
