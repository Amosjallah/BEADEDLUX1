      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            <select
              ...
              className="px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 font-medium pr-8 cursor-pointer bg-white"
            >
            ...
            <button className="bg-sky-700 hover:bg-sky-800 text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap cursor-pointer flex items-center justify-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 flex items-center justify-center bg-sky-100 rounded-lg">
                <i className="ri-money-dollar-circle-line text-2xl text-sky-700"></i>
              </div>
              <span className="text-sky-700 font-semibold text-sm">Live</span>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 flex items-center justify-center bg-sky-100 rounded-lg">
                <i className="ri-shopping-cart-line text-2xl text-sky-700"></i>
              </div>
            </div>
                ...
                <tbody className="divide-y divide-gray-100">
                  {topProducts.map((product, index) => (
                    <tr key={index}>
                      ...
                      <td className="py-3 text-right text-sm font-semibold text-sky-600">${product.revenue.toLocaleString()}</td>
                    </tr>
                  ))}
