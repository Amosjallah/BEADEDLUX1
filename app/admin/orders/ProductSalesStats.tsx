...
export default function ProductSalesStats({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-sky-600/60 backdrop-blur-sm">
                            ...
                            {loading ? (
                                <tr>
                                    <td colSpan={4} className="p-12 text-center text-gray-500">
                                        <i className="ri-loader-4-line text-3xl animate-spin text-sky-600 mb-2 block"></i>
                                        Loading sales data...
                                    </td>
                                </tr>
                            ) : stats.length === 0 ? (
