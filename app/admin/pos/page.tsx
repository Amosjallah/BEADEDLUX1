...
export default function POSPage() {
    ...
    return (
        <div className="flex flex-col lg:flex-row h-[calc(100vh-90px)] -m-4 lg:-m-6 overflow-hidden bg-gray-100 relative">
                            ...
                            {filteredProducts.map(product => (
                                ...
                                >
                                    <div className="aspect-square relative bg-gray-50 shrink-0">
                                        ...
                                        />
                                        <div className="absolute top-2 right-2 bg-sky-600/60 text-white text-xs px-2 py-1 rounded-full backdrop-blur-sm">
                                    ...
                                    <div className="p-3 flex flex-col flex-1">
                                        ...
                                        <div className="flex items-center justify-between mt-2 pt-2">
                                            ...
                                            <button className="w-8 h-8 rounded-full bg-sky-50 text-sky-700 flex items-center justify-center group-hover:bg-sky-700 group-hover:text-white transition-colors">
                ...
                {cart.length > 0 && (
                    <div className="lg:hidden p-4 border-t border-gray-200 bg-white fixed bottom-0 left-0 right-0 z-30 shadow-2xl safe-area-bottom">
                        <button
                            ...
                            className="w-full py-3 bg-sky-700 text-white rounded-xl font-bold flex justify-between px-6 shadow-lg active:scale-95 transition-transform"
                        >
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3">
                    {cart.length === 0 ? (
                        <div className="flex flex-col items-center justify-center h-full text-gray-400 space-y-4">
                            ...
                            <button onClick={() => setIsMobileCartOpen(false)} className="lg:hidden text-sky-600 font-medium hover:underline">
                ...
                <div className="p-4 bg-gray-50 border-t border-gray-200 space-y-4 shrink-0 safe-area-bottom">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                        ...
                        <button
                            ...
                            disabled={cart.length === 0}
                            className="px-4 py-3 bg-sky-600 text-white rounded-lg hover:bg-sky-700 font-bold text-sm shadow-sm transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
            ...
            {/* Checkout Modal */}
            {showCheckoutModal && (
                <div className="fixed inset-0 bg-sky-600/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                        {completedOrder ? (
                            // SUCCESS STATE
                            <div className="p-8 text-center flex flex-col items-center justify-center space-y-6 overflow-y-auto">
                                <div className={`w-20 h-20 rounded-full flex items-center justify-center ${completedOrder.paymentPending ? 'bg-amber-100' : 'bg-sky-100'}`}>
                                    <i className={`text-5xl ${completedOrder.paymentPending ? 'ri-time-line text-amber-600' : 'ri-checkbox-circle-fill text-sky-600'}`}></i>
                                </div>
                                <div>
                                    ...
                                    {!completedOrder.paymentPending && paymentMethod === 'cash' && changeDue > 0 && (
                                        <div className="mt-3 bg-sky-50 border border-sky-200 rounded-lg p-3">
                                            <p className="text-sm text-sky-700">Change Due</p>
                                            <p className="text-2xl font-bold text-sky-800">${changeDue.toFixed(2)}</p>
                                        </div>
                                    )}
                                        ...
                                        <div className="mt-4 space-y-3">
                                            ...
                                            <div className="mt-2">
                                                <button
                                                    ...
                                                    className="text-sm text-sky-700 hover:text-sky-800 font-medium underline"
                                                >
                                ...
                                <div className="grid grid-cols-2 gap-4 w-full mt-4">
                                    ...
                                    <button onClick={resetCheckout} className="py-3 px-4 bg-sky-600 text-white rounded-xl font-semibold hover:bg-sky-700 transition-colors">
                                        New Order
                                    </button>
                                </div>
                            </div>
                            ...
                            <>
                                ...
                                <div className="p-6 space-y-6 overflow-y-auto">
                                    ...
                                    {/* Total Display */}
                                    <div className="text-center py-4 bg-sky-50 rounded-xl border border-sky-100">
                                        <p className="text-sm text-sky-800 uppercase tracking-wide font-semibold">Amount to Pay</p>
                                        <p className="text-4xl font-extrabold text-sky-700 mt-1">${grandTotal.toFixed(2)}</p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="relative mb-2">
                                            ...
                                            <input
                                                ...
                                                className="w-full pl-9 pr-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 outline-none text-sm"
                                            />
                                        </div>

                                        <select
                                            className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 outline-none mb-2"
                                            onChange={(e) => {
                                        ...
                                        {selectedCustomer && (
                                            <div className="bg-sky-50 border border-sky-200 rounded-lg p-3 mb-2 flex items-center justify-between">
                                                <div>
                                            ...
                                            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200 mt-2 space-y-3">
                                                ...
                                                <div className="grid grid-cols-2 gap-3">
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-sky-500 text-sm ${paymentMethod === 'momo' && !guestDetails.phone ? 'border-amber-400 bg-amber-50' : 'border-gray-300'
                                                            }`}
                                                    />
                                                </div>
                                            </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            ...
                                            >
                                                <i className={`ri-store-2-line text-xl ${deliveryMethod === 'pickup' ? 'text-sky-700' : 'text-gray-400'}`}></i>
                                                <div className="text-left">
                                                    <p className={`text-sm font-semibold ${deliveryMethod === 'pickup' ? 'text-sky-800' : 'text-gray-700'}`}>Store Pickup</p>
                                            ...
                                            >
                                                <i className={`ri-truck-line text-xl ${deliveryMethod === 'doorstep' ? 'text-sky-700' : 'text-gray-400'}`}></i>
                                                <div className="text-left">
                                                    <p className={`text-sm font-semibold ${deliveryMethod === 'doorstep' ? 'text-sky-800' : 'text-gray-700'}`}>Doorstep Delivery</p>
                                        ...
                                        {deliveryMethod === 'doorstep' && (
                                            <div className="mt-3 bg-sky-50 p-4 rounded-lg border border-sky-200 space-y-3">
                                                <h4 className="text-sm font-bold text-gray-900 flex items-center">
                                                    <i className="ri-map-pin-line mr-2 text-sky-600"></i>
                                                    Delivery Address
                                                </h4>
                                                <input
                                                    type="text"
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 outline-none font-bold text-lg"
                                                    placeholder="0.00"
                                                    autoFocus
                                                />
                                            </div>
                                            {changeDue > 0 && (
                                                <p className="text-right text-sky-600 font-bold mt-2">Change: ${changeDue.toFixed(2)}</p>
                                            )}
                                    ...
                                    {paymentMethod === 'card' && (
                                        <div className="bg-sky-50 border border-sky-200 rounded-lg p-3">
                                            <div className="flex items-start space-x-2">
                                                <i className="ri-bank-card-line text-sky-600 mt-0.5"></i>
                                ...
                                <div className="p-6 border-t border-gray-100 bg-gray-50 shrink-0">
                                    <button
                                        ...
                                        disabled={processing}
                                        className="w-full py-4 bg-sky-600 text-white rounded-xl font-bold text-lg shadow-lg hover:bg-sky-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center justify-center space-x-2"
                                    >
                                        {processing ? (
                                            <>
