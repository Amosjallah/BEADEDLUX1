    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          ...
          <Link
            href="/admin"
            className="bg-sky-600 hover:bg-sky-500 text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap text-center"
          >
            Back to Dashboard
          </Link>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              ...
              <div className="w-12 h-12 flex items-center justify-center bg-sky-100 rounded-lg">
                <i className="ri-stack-line text-2xl text-sky-600"></i>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-sky-600">${totalValue.toLocaleString(undefined, { maximumFractionDigits: 0 })}</p>
              </div>
              <div className="w-12 h-12 flex items-center justify-center bg-sky-100 rounded-lg">
                <i className="ri-money-dollar-circle-line text-2xl text-sky-600"></i>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="bg-sky-700 hover:bg-sky-800 text-white px-4 py-3 rounded-lg font-semibold transition-colors flex items-center space-x-2 whitespace-nowrap cursor-pointer"
              >
            ...
            <div className="mt-4 flex items-center justify-between p-4 bg-sky-50 border border-sky-200 rounded-lg">
              ...
              <div className="flex items-center space-x-3">
                <button
                  ...
                  className="bg-sky-700 hover:bg-sky-800 text-white px-4 py-2 rounded-lg font-semibold transition-colors whitespace-nowrap cursor-pointer"
                >
                  Bulk Restock
                </button>
                <button
                ...
                <tr>
                  <th className="px-6 py-4 text-left">
                    <input
                      ...
                      className="w-5 h-5 text-sky-700 rounded cursor-pointer"
                    />
                  </th>
                ...
                {loading ? (
                  ...
                  filteredProducts.map((product) => (
                    <tr key={product.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4">
                        {product.status === 'good' && (
                          <span className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-sky-100 text-sky-700 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center space-x-2">
                          <button
                            className="w-8 h-8 flex items-center justify-center text-gray-600 hover:text-sky-700 transition-colors cursor-pointer"
                            title="Edit"
                          >
