      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-8">
          <div className="lg:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            <div className="flex items-center justify-between mb-4">
              ...
              <select
                className="bg-gray-50 border border-gray-200 text-gray-700 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block p-2"
                value={dateRange}
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <div className="space-y-3">
              <Link href="/admin/products/new" className="flex items-center justify-between p-4 bg-gray-50 hover:bg-sky-50 text-gray-700 hover:text-sky-700 rounded-lg transition-colors group">
                <div className="flex items-center font-medium">
                  <span className="w-8 h-8 rounded-full bg-white flex items-center justify-center mr-3 group-hover:bg-sky-100 transition-colors shadow-sm">
              ...
              <Link href="/admin/pos" className="flex items-center justify-between p-4 bg-gray-50 hover:bg-sky-50 text-gray-700 hover:text-sky-700 rounded-lg transition-colors group">
                <div className="flex items-center font-medium">
                  <span className="w-8 h-8 rounded-full bg-white flex items-center justify-center mr-3 group-hover:bg-sky-100 transition-colors shadow-sm">
              ...
              <Link href="/admin/orders" className="flex items-center justify-between p-4 bg-gray-50 hover:bg-sky-50 text-gray-700 hover:text-sky-700 rounded-lg transition-colors group">
                <div className="flex items-center font-medium">
                  <span className="w-8 h-8 rounded-full bg-white flex items-center justify-center mr-3 group-hover:bg-sky-100 transition-colors shadow-sm">
        ...
        <div className="grid lg:grid-cols-3 gap-6 mb-8">
          <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 overflow-hidden">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/admin/orders" className="text-sky-700 hover:text-sky-800 font-medium text-sm whitespace-nowrap cursor-pointer">
                    ...
                    {recentOrders.map((order) => (
                      <tr key={order.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                        <td className="py-4 px-4">
                          <Link href={`/admin/orders/${order.id}`} className="text-sky-700 hover:text-sky-800 font-medium whitespace-nowrap cursor-pointer">
                            {order.displayId}
                          </Link>
                        </td>
                        <td className="py-4 px-4">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
              ...
              <Link href="/admin/products?filter=low-stock" className="block text-center mt-4 text-sky-700 hover:text-sky-800 font-medium text-sm whitespace-nowrap cursor-pointer">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 overflow-hidden">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/admin/products" className="text-sky-700 hover:text-sky-800 font-medium text-sm whitespace-nowrap cursor-pointer">
              View All <i className="ri-arrow-right-line ml-1"></i>
            </Link>
          </div>
            ...
            {topProducts.map((product) => (
              <div key={product.id} className="border border-gray-200 rounded-xl p-4 hover:shadow-md transition-shadow">
                ...
                <div className="mt-3 pt-3 border-t border-gray-200 flex items-center justify-between">
                  ...
                  <Link href={`/admin/products/${product.id}`} className="text-sky-700 hover:text-sky-800 text-sm font-medium whitespace-nowrap cursor-pointer">
