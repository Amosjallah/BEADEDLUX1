        ...
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex space-x-3">
                    ...
                    <button className="px-4 py-2 bg-sky-600 text-white rounded-lg font-bold hover:bg-sky-700 cursor-pointer">
                        Edit Customer
                    </button>
                </div>
            </div>
                                ...
                                <tr key={order.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium capitalize
                                            ${order.status === 'completed' || order.status === 'delivered' ? 'bg-sky-100 text-sky-800' :
                                    ...
                                    <td className="px-6 py-4 text-right">
                                        <Link href={`/admin/orders/${order.id}`} className="text-gray-400 hover:text-sky-600">
