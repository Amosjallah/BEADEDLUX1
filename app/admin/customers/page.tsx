  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button className="bg-sky-700 hover:bg-sky-800 text-white px-6 py-3 rounded-lg font-semibold transition-colors whitespace-nowrap cursor-pointer">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl border-2 border-gray-200 p-4">
          ...
          <p className="text-2xl font-bold text-sky-700">{stats.newThisMonth}</p>
        </div>
        <div className="bg-white rounded-xl border-2 border-gray-200 p-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            <div className="flex-1 max-w-md">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 text-sm"
                />
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              <select
                ...
                className="px-4 py-3 pr-8 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 font-medium cursor-pointer"
              >
        ...
        {selectedCustomers.length > 0 && (
          <div className="p-4 bg-sky-50 border-b border-sky-200 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              <button className="px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-lg text-sm font-medium transition-colors whitespace-nowrap cursor-pointer">
              ...
              <button className="px-4 py-2 bg-gray-700 hover:bg-sky-500 text-white rounded-lg text-sm font-medium transition-colors whitespace-nowrap cursor-pointer">
                <i className="ri-download-line mr-2"></i>
                Export
              </button>
            </div>
                ...
                filteredCustomers.map((customer) => (
                  <tr key={customer.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center space-x-3">
                        <div className="w-10 h-10 flex items-center justify-center bg-sky-100 text-sky-700 rounded-full font-semibold">
                          {customer.avatar}
                        </div>
                        <div>
                          <Link href={`/admin/customers/${customer.id}`} className="font-semibold text-gray-900 hover:text-sky-700 whitespace-nowrap">
                            {customer.name}
                          </Link>
                    ...
                    <td className="py-4 px-4 font-semibold text-sky-700 whitespace-nowrap">$ {customer.totalSpent.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                    ...
                    <td className="py-4 px-4">
                      <div className="flex items-center space-x-2">
                        ...
                        <button className="w-8 h-8 flex items-center justify-center text-gray-600 hover:text-sky-700 hover:bg-sky-50 rounded-lg transition-colors cursor-pointer">
