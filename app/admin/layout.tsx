...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {isSidebarOpen && (
        <div
          className="fixed inset-0 bg-sky-600/50 z-30 lg:hidden glass-overlay"
      ...
      >
        <div className="h-full px-4 py-6 overflow-y-auto">
          <Link href="/admin" className="flex items-center mb-8 px-2 cursor-pointer">
            <span className="text-xl font-['Pacifico'] text-sky-700">TIWAA PERFUME</span>
          ...
          <div className="px-4 py-4 lg:px-6 flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2 lg:space-x-4">
              ...
              <div className="relative user-menu-container">
                ...
                >
                  <div className="w-8 h-8 lg:w-9 lg:h-9 flex items-center justify-center bg-sky-100 text-sky-700 rounded-full font-semibold">
