        ...
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-6 rounded-lg shadow border border-gray-100">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                type="text"
                                className="w-full border rounded-md p-2 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-sky-500 outline-none"
                        ...
                        <div>
                            ...
                            <textarea
                                className="w-full border rounded-md p-2 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-sky-500 outline-none h-24"
                ...
                <div className="bg-white p-6 rounded-lg shadow border border-gray-100">
                    ...
                    {result ? (
                        <div className="bg-sky-600 text-gray-100 p-4 rounded-md font-mono text-sm overflow-auto max-h-[500px]">
