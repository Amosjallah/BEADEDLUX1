...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-white to-gray-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="inline-block">
            <img src="/logo.png" alt="BEADEDLUX" className="h-16 w-auto mx-auto object-contain" />
          </Link>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500"
            ...
            <button
              ...
              className="w-full bg-sky-700 hover:bg-sky-800 text-white py-3 rounded-lg font-semibold transition-colors disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
            >
              {isLoading || verifying ? (
        ...
        <div className="mt-6 text-center">
          <Link href="/" className="text-sm text-gray-600 hover:text-sky-700 transition-colors whitespace-nowrap">
