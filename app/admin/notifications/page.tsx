    ...
    return (
        <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
                ...
                {success && <div className="bg-sky-50 text-sky-700 p-4 rounded-lg mb-4">{success}</div>}
                ...
                <form onSubmit={handleSend} className="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full p-3 border border-gray-300 rounded-lg h-40 outline-none focus:ring-2 focus:ring-sky-500"
                    ...
                    <button
                        ...
                        className="w-full bg-sky-700 text-white py-4 rounded-lg font-bold text-lg hover:bg-sky-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
                    >
                        {loading ? (
